...
class DetailViewModel (private val buyerRepository: BuyerRepository, private val repository: Repository) : ViewModel() {
    ...
    private val _getBuyerOrder :  MutableLiveData<Resource<List<GetOrderResponse.GetOrderResponseItem>>> = MutableLiveData()
    val getBuyerOrder : LiveData<Resource<List<GetOrderResponse.GetOrderResponseItem>>> get() = _getBuyerOrder
