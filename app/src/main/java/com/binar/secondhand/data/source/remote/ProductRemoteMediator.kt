...
class ProductRemoteMediator(
    ...
    private fun getRemoteKeyForLastItem(state: PagingState<Int, GetProductResponseItem>): RemoteKeys? {
    ...
    private fun getRemoteKeyForFirstItem(state: PagingState<Int, GetProductResponseItem>): RemoteKeys? {
